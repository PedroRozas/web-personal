...
export default function Hero() {
  return (
    <section className="container min-h-[calc(100vh-4rem)] flex items-center justify-center py-24 sm:py-32 px-4">
      <div className="flex flex-col items-center text-center space-y-12 animate-fade-in max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-8 stagger-animation w-full">
